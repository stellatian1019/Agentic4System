...
class InferenceWorker:
    ...
    def __init__(self):
        ...
        # Repeated warmup/timed tasks use the same immutable input directory.
        self.input_cache = {}
    ...
    def get_inputs(self, input_dir):
        ...
        if key not in self.input_cache:
            self.input_cache[key] = load_manifest(input_dir)
    ...
    def run_task(
        ...
        manifest, tensors = self.get_inputs(input_dir)
